...
class JoystickController(object):
    ...
    """
    # Change the values here to change the axis for angle and the anxis for throttle
    def __init__(self, poll_delay=0.0,
                 max_throttle=1.0,
                 steering_axis='x',
                 # 20190314 Ingmar Stapel used an additional 
                 # throttle axis ry to use the right joystick optional
                 throttle_axis_ry='ry',
                 throttle_axis='rz',
                 steering_scale=1.0,
                 throttle_scale=-1.0,
        ...
        # 20190315 Ingmar Stapel
        self.throttle_axis_ry = throttle_axis_ry
    ...
    def update(self):
        ...
        * cross = PS3 cross => decrease max throttle
        ...
        while self.running:
            ...
            # Modified by Ingmar Stapel 20190201
            #print(button)
            ...
            # 20190314 Ingmar Stapel changed to use both the rz and ry axis 
            ...
            if axis == self.throttle_axis_ry:   
                self.throttle = (self.throttle_scale * axis_val * -1 * self.max_throttle)             
                print("throttle", self.throttle)
                self.on_throttle_changes()
            ...
            if button == 'b_' and button_state == 1:
                """
